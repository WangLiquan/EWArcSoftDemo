...
- (CAKeyframeAnimation *)backgroundColorAnimation {
    ...
    backgroundColorAnimation.values = @[(__bridge id)ColorWithAlpha(255, 255, 255, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(255, 255, 255, 0.5).CGColor,
                                        (__bridge id)ColorWithAlpha(255, 255, 255, 0.5).CGColor,
...
- (CAKeyframeAnimation *)borderColorAnimation {
    ...
    borderColorAnimation.values = @[(__bridge id)ColorWithAlpha(255, 255, 255, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(255, 255, 255, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(255,255, 255, 0.5).CGColor,
                                    (__bridge id)ColorWithAlpha(255, 255, 255, 0).CGColor];
